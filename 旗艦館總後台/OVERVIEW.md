...
- 對應前台大改版（2026-09-03）：非本家頁搬到站台根 **`game.htm`**（舊 `game/game.html` 已刪）；
...
- v10（2026-09-03）：非本家頁新增「🧱 遊戲牆工作台」（卡片式 ⭐置頂／🚫隱藏／🎯類型／📅補發售日，寫新節點 nintendo_tp_dates；前台同款分區預覽＋缺日期頁籤）；舊 textarea 收進備援摺疊。配合前台大改版：game/game.html → 站台根 game.htm（舊檔已刪）、商品牆改發售日主軸（三大區塊＋月份牆切換）。
